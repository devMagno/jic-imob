...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <ul class="swiper-wrapper my-gallery">
          ...
          ?>
            <li class="swiper-slide" id="<?php echo $index ?>">
              <a href="<?php echo $image['inner-image'] ?>" title="Clique ou aperte para aproximar" data-size="1200x600">
                <img src="<?php echo get_template_directory_uri(); ?>/img/pixel.png" data-src="<?php echo $image['inner-image'] ?>" alt="<?php the_title(); ?>" class="swiper-lazy">
    ...
    <section class="single container">
      ...
      <ul class="advert__info flex flex--justify-sb flex--wrap">
        ...
        <li class="advert__info-item flex flex--col flex--items-c">
          <span class="advert__icon advert__icon--big fas fa-th-large flex flex--items-c flex--justify-c"></span>
